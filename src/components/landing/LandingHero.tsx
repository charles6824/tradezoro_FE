    ...
    <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
      <div className="max-w-2xl">
        ...
        <h1 className="text-6xl md:text-7xl font-black leading-[1.1] mb-6 tracking-tight">
          Invest On Over <br />
          <span className="text-primary">500+ Stocks Worldwide</span>
        </h1>
        <p className="text-xl text-slate-400 mb-10 max-w-lg leading-relaxed">
          TradeZero provides the professional tools and market access you need to excel in the high-speed trading world. Zero commission options available.
        </p>
        <div className="flex flex-col sm:flex-row gap-4">
          <button className="px-10 py-5 rounded-full bg-primary text-background-dark font-black text-lg hover:scale-105 transition-transform">
            Open an Account
          </button>
          <button className="px-10 py-5 rounded-full border border-primary/30 font-bold text-lg hover:bg-primary/5 transition-colors">
            Learn More
          </button>
        </div>
      </div>
