			...
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
				<div className="max-w-2xl">
					...
					<p className="text-xl text-slate-300 mb-12 leading-relaxed">
						Trusted by Over 100,000 Clients: Lightning-Fast Trades, Low Fees and
						an Exceptional Trading Experience.
					</p>
					<div className="flex flex-col sm:flex-row gap-5">
						<Link
							to="/register"
							className="px-8 py-4 bg-primary text-background-dark rounded-xl font-bold text-lg hover:brightness-110 transition-all flex items-center justify-center gap-2"
						>
							Start Trading{" "}
