  ...
  return (
    <div className="max-w-7xl mx-auto px-4 mb-24">
      <div className="bg-primary rounded-xl p-12 text-center relative overflow-hidden group">
        ...
        <h2 className="text-background-dark text-4xl md:text-5xl font-black mb-8 relative z-10">{t("Start Trading Today")}</h2>
        <p className="text-background-dark/80 text-xl mb-10 max-w-xl mx-auto relative z-10 font-medium">{t("Join thousands of professional traders who rely on TradeZero for their market access.")}</p>
