...
const StepsSection = () => (
  <section className="py-24 bg-background-light dark:bg-[#08150d]">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <h2 className="text-4xl font-black text-center mb-16">Open An Account In 3 Easy Steps</h2>
      <div className="grid md:grid-cols-3 gap-8">
        <div className="relative p-10 rounded-2xl bg-background-dark border border-primary/10 text-center">
          ...
          <p className="text-slate-400">Complete our secure online application in minutes.</p>
        </div>
        <div className="relative p-10 rounded-2xl bg-background-dark border border-primary/10 text-center">
          ...
          <p className="text-slate-400">Add capital via wire transfer, ACH, or account transfer.</p>
        </div>
        <div className="relative p-10 rounded-2xl bg-background-dark border border-primary/10 text-center">
          ...
          <p className="text-slate-400">Start executing trades on your platform of choice.</p>
        </div>
      </div>
    </div>
  </section>
